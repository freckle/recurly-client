...
module RecurlyClient.Operations.Mark_invoice_successful where
...
mark_invoice_successful ::
    ...
    RecurlyClient.Common.ClientT m (Network.HTTP.Client.Types.Response Mark_invoice_successfulResponse)
mark_invoice_successful invoice_id =
    GHC.Base.fmap
        ( \response_0 ->
            GHC.Base.fmap
                ( Data.Either.either Mark_invoice_successfulResponseError GHC.Base.id
                    GHC.Base.. ( \response body ->
                                    if
                                        | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) ->
                                            Mark_invoice_successfulResponse200
                                        ...
                                        | (\status_2 -> Network.HTTP.Types.Status.statusCode status_2 GHC.Classes.== 404) (Network.HTTP.Client.Types.responseStatus response) ->
                                            Mark_invoice_successfulResponse404
                                                Data.Functor.<$> ( Data.Aeson.eitherDecodeStrict body ::
                                                                    Data.Either.Either
                                                                        GHC.Base.String
                                                                        Error
                                        ...
                                        | (\status_3 -> Network.HTTP.Types.Status.statusCode status_3 GHC.Classes.== 422) (Network.HTTP.Client.Types.responseStatus response) ->
                                            Mark_invoice_successfulResponse422
                                                Data.Functor.<$> ( Data.Aeson.eitherDecodeStrict body ::
                                                                    Data.Either.Either
                                                                        GHC.Base.String
                                                                        Error
                                        ...
                                        | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) ->
                                            Mark_invoice_successfulResponseDefault
                                                Data.Functor.<$> ( Data.Aeson.eitherDecodeStrict body ::
                                                                    Data.Either.Either
                                                                        GHC.Base.String
                                                                        Error
...
data Mark_invoice_successfulResponse
    = -- | Means either no matching case available or a parse error
      Mark_invoice_successfulResponseError GHC.Base.String
    | -- | The updated invoice.
      Mark_invoice_successfulResponse200 Invoice
    | -- | Incorrect site or invoice ID.
      Mark_invoice_successfulResponse404 Error
    | -- | Tried marking a closed (successful or failed) invoice as successful.
      Mark_invoice_successfulResponse422 Error
    | -- | Unexpected error.
      Mark_invoice_successfulResponseDefault Error
    deriving (GHC.Show.Show, GHC.Classes.Eq)

{- | > PUT /invoices/{invoice_id}/mark_successful

The same as 'mark_invoice_successful' but accepts an explicit configuration.
-}
mark_invoice_successfulWithConfiguration ::
    forall m.
    (RecurlyClient.Common.MonadHTTP m) =>
    ...
    Data.Text.Internal.Text ->
    -- | Monadic computation which returns the result of the operation
    m (Network.HTTP.Client.Types.Response Mark_invoice_successfulResponse)
mark_invoice_successfulWithConfiguration
    config
    invoice_id =
        GHC.Base.fmap
...
The same as 'mark_invoice_successful' but returns the raw 'Data.ByteString.ByteString'.
-}
mark_invoice_successfulRaw ::
    forall m.
    (RecurlyClient.Common.MonadHTTP m) =>
    -- | invoice_id: Invoice ID or number. For ID no prefix is used e.g. \`e28zov4fw0v2\`. For number use prefix \`number-\`, e.g. \`number-1000\`.
    Data.Text.Internal.Text ->
...
mark_invoice_successfulRaw invoice_id = GHC.Base.id (RecurlyClient.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "PUT") ("/invoices/" GHC.Base.<> (RecurlyClient.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (RecurlyClient.Common.textToByte GHC.Base.$ RecurlyClient.Common.stringifyModel invoice_id)) GHC.Base.<> "/mark_successful")) GHC.Base.mempty)

{- | > PUT /invoices/{invoice_id}/mark_successful

The same as 'mark_invoice_successful' but accepts an explicit configuration and returns the raw 'Data.ByteString.ByteString'.
-}
mark_invoice_successfulWithConfigurationRaw ::
    forall m.
    (RecurlyClient.Common.MonadHTTP m) =>
    -- | The configuration to use in the request
    RecurlyClient.Common.Configuration ->
