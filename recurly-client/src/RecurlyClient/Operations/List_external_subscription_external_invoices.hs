...
list_external_subscription_external_invoices parameters =
    GHC.Base.fmap
        ( \response_0 ->
            GHC.Base.fmap
                ( Data.Either.either List_external_subscription_external_invoicesResponseError GHC.Base.id
        ...
        ( RecurlyClient.Common.doCallWithConfigurationM
            ...
            [ RecurlyClient.Common.QueryParameter (Data.Text.Internal.pack "sort") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> list_external_subscription_external_invoicesParametersQuerySort parameters) (Data.Text.Internal.pack "form") GHC.Types.False
            , RecurlyClient.Common.QueryParameter (Data.Text.Internal.pack "limit") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> list_external_subscription_external_invoicesParametersQueryLimit parameters) (Data.Text.Internal.pack "form") GHC.Types.False
            , RecurlyClient.Common.QueryParameter (Data.Text.Internal.pack "order") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> list_external_subscription_external_invoicesParametersQueryOrder parameters) (Data.Text.Internal.pack "form") GHC.Types.False
            ]
        )
...
instance Data.Aeson.Types.ToJSON.ToJSON List_external_subscription_external_invoicesParameters where
    toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryLimit" Data.Aeson.Types.ToJSON..=)) (list_external_subscription_external_invoicesParametersQueryLimit obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryOrder" Data.Aeson.Types.ToJSON..=)) (list_external_subscription_external_invoicesParametersQueryOrder obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("querySort" Data.Aeson.Types.ToJSON..=)) (list_external_subscription_external_invoicesParametersQuerySort obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON List_external_subscription_external_invoicesParameters where
    parseJSON = Data.Aeson.Types.FromJSON.withObject "List_external_subscription_external_invoicesParameters" (\obj -> ((GHC.Base.pure List_external_subscription_external_invoicesParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "queryLimit")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "queryOrder")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "querySort"))
...
mkList_external_subscription_external_invoicesParameters =
    List_external_subscription_external_invoicesParameters
        { list_external_subscription_external_invoicesParametersQueryLimit = GHC.Maybe.Nothing
        , list_external_subscription_external_invoicesParametersQueryOrder = GHC.Maybe.Nothing
        , list_external_subscription_external_invoicesParametersQuerySort = GHC.Maybe.Nothing
        }
...
instance Data.Aeson.Types.ToJSON.ToJSON List_external_subscription_external_invoicesParametersQueryOrder where
    toJSON (List_external_subscription_external_invoicesParametersQueryOrderOther val) = val
    toJSON (List_external_subscription_external_invoicesParametersQueryOrderTyped val) = Data.Aeson.Types.ToJSON.toJSON val
    toJSON (List_external_subscription_external_invoicesParametersQueryOrderEnumAsc) = "asc"
    toJSON (List_external_subscription_external_invoicesParametersQueryOrderEnumDesc) = "desc"
instance Data.Aeson.Types.FromJSON.FromJSON List_external_subscription_external_invoicesParametersQueryOrder where
    parseJSON val =
        GHC.Base.pure
            ( if
                | val GHC.Classes.== "asc" -> List_external_subscription_external_invoicesParametersQueryOrderEnumAsc
                | val GHC.Classes.== "desc" -> List_external_subscription_external_invoicesParametersQueryOrderEnumDesc
                | GHC.Base.otherwise -> List_external_subscription_external_invoicesParametersQueryOrderOther val
            )
...
instance Data.Aeson.Types.ToJSON.ToJSON List_external_subscription_external_invoicesParametersQuerySort where
    toJSON (List_external_subscription_external_invoicesParametersQuerySortOther val) = val
    toJSON (List_external_subscription_external_invoicesParametersQuerySortTyped val) = Data.Aeson.Types.ToJSON.toJSON val
    toJSON (List_external_subscription_external_invoicesParametersQuerySortEnumCreated_at) = "created_at"
    toJSON (List_external_subscription_external_invoicesParametersQuerySortEnumUpdated_at) = "updated_at"
instance Data.Aeson.Types.FromJSON.FromJSON List_external_subscription_external_invoicesParametersQuerySort where
    parseJSON val =
        GHC.Base.pure
            ( if
                | val GHC.Classes.== "created_at" -> List_external_subscription_external_invoicesParametersQuerySortEnumCreated_at
                | val GHC.Classes.== "updated_at" -> List_external_subscription_external_invoicesParametersQuerySortEnumUpdated_at
                | GHC.Base.otherwise -> List_external_subscription_external_invoicesParametersQuerySortOther val
            )
...
list_external_subscription_external_invoicesRaw parameters =
    GHC.Base.id
        ( RecurlyClient.Common.doCallWithConfigurationM
            (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET")
            "/external_subscriptions/{external_subscription_id}/external_invoices"
