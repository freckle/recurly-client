...
module RecurlyClient.Operations.Preview_invoice where
...
preview_invoice ::
    ...
    RecurlyClient.Common.ClientT m (Network.HTTP.Client.Types.Response Preview_invoiceResponse)
preview_invoice
    account_id
    body =
        GHC.Base.fmap
            ( \response_0 ->
                GHC.Base.fmap
                    ( Data.Either.either Preview_invoiceResponseError GHC.Base.id
                        GHC.Base.. ( \response body ->
                                        if
                                            | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) ->
                                                Preview_invoiceResponse200
                                            ...
                                            | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) ->
                                                Preview_invoiceResponseDefault
                                                    Data.Functor.<$> ( Data.Aeson.eitherDecodeStrict body ::
                                                                        Data.Either.Either
                                                                            GHC.Base.String
                                                                            Error
...
data Preview_invoiceResponse
    = -- | Means either no matching case available or a parse error
      Preview_invoiceResponseError GHC.Base.String
...
-}
preview_invoiceWithConfiguration ::
    forall m.
    (RecurlyClient.Common.MonadHTTP m) =>
    ...
    InvoiceCreate ->
    -- | Monadic computation which returns the result of the operation
    m (Network.HTTP.Client.Types.Response Preview_invoiceResponse)
preview_invoiceWithConfiguration
    config
    account_id
    body =
...
The same as 'preview_invoice' but returns the raw 'Data.ByteString.ByteString'.
-}
preview_invoiceRaw ::
    forall m.
    (RecurlyClient.Common.MonadHTTP m) =>
...
The same as 'preview_invoice' but accepts an explicit configuration and returns the raw 'Data.ByteString.ByteString'.
-}
preview_invoiceWithConfigurationRaw ::
    forall m.
    (RecurlyClient.Common.MonadHTTP m) =>
    -- | The configuration to use in the request
    RecurlyClient.Common.Configuration ->
