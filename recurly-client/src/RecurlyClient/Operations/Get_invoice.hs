...
module RecurlyClient.Operations.Get_invoice where
...
get_invoice ::
    ...
    RecurlyClient.Common.ClientT m (Network.HTTP.Client.Types.Response Get_invoiceResponse)
get_invoice invoice_id =
    GHC.Base.fmap
        ( \response_0 ->
            GHC.Base.fmap
                ( Data.Either.either Get_invoiceResponseError GHC.Base.id
                    GHC.Base.. ( \response body ->
                                    if
                                        | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) ->
                                            Get_invoiceResponse200
...
data Get_invoiceResponse
    = -- | Means either no matching case available or a parse error
      Get_invoiceResponseError GHC.Base.String
    | -- | An invoice.
...
get_invoiceWithConfiguration ::
    ...
    Data.Text.Internal.Text ->
    -- | Monadic computation which returns the result of the operation
    m (Network.HTTP.Client.Types.Response Get_invoiceResponse)
get_invoiceWithConfiguration
    config
    invoice_id =
        GHC.Base.fmap
...
The same as 'get_invoice' but returns the raw 'Data.ByteString.ByteString'.
-}
get_invoiceRaw ::
    forall m.
    (RecurlyClient.Common.MonadHTTP m) =>
...
get_invoiceRaw invoice_id = GHC.Base.id (RecurlyClient.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") ("/invoices/" GHC.Base.<> (RecurlyClient.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (RecurlyClient.Common.textToByte GHC.Base.$ RecurlyClient.Common.stringifyModel invoice_id)) GHC.Base.<> "")) GHC.Base.mempty)

{- | > GET /invoices/{invoice_id}

The same as 'get_invoice' but accepts an explicit configuration and returns the raw 'Data.ByteString.ByteString'.
-}
get_invoiceWithConfigurationRaw ::
    forall m.
    (RecurlyClient.Common.MonadHTTP m) =>
    -- | The configuration to use in the request
    RecurlyClient.Common.Configuration ->
