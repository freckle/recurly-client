...
list_external_subscription_external_payment_phases parameters =
    GHC.Base.fmap
        ( \response_0 ->
            GHC.Base.fmap
                ( Data.Either.either List_external_subscription_external_payment_phasesResponseError GHC.Base.id
        ...
        ( RecurlyClient.Common.doCallWithConfigurationM
            ...
            [ RecurlyClient.Common.QueryParameter (Data.Text.Internal.pack "sort") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> list_external_subscription_external_payment_phasesParametersQuerySort parameters) (Data.Text.Internal.pack "form") GHC.Types.False
            , RecurlyClient.Common.QueryParameter (Data.Text.Internal.pack "limit") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> list_external_subscription_external_payment_phasesParametersQueryLimit parameters) (Data.Text.Internal.pack "form") GHC.Types.False
            , RecurlyClient.Common.QueryParameter (Data.Text.Internal.pack "order") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> list_external_subscription_external_payment_phasesParametersQueryOrder parameters) (Data.Text.Internal.pack "form") GHC.Types.False
            ]
        )
...
instance Data.Aeson.Types.ToJSON.ToJSON List_external_subscription_external_payment_phasesParameters where
    toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryLimit" Data.Aeson.Types.ToJSON..=)) (list_external_subscription_external_payment_phasesParametersQueryLimit obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryOrder" Data.Aeson.Types.ToJSON..=)) (list_external_subscription_external_payment_phasesParametersQueryOrder obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("querySort" Data.Aeson.Types.ToJSON..=)) (list_external_subscription_external_payment_phasesParametersQuerySort obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON List_external_subscription_external_payment_phasesParameters where
    parseJSON = Data.Aeson.Types.FromJSON.withObject "List_external_subscription_external_payment_phasesParameters" (\obj -> ((GHC.Base.pure List_external_subscription_external_payment_phasesParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "queryLimit")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "queryOrder")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "querySort"))
...
mkList_external_subscription_external_payment_phasesParameters =
    List_external_subscription_external_payment_phasesParameters
        { list_external_subscription_external_payment_phasesParametersQueryLimit = GHC.Maybe.Nothing
        , list_external_subscription_external_payment_phasesParametersQueryOrder = GHC.Maybe.Nothing
        , list_external_subscription_external_payment_phasesParametersQuerySort = GHC.Maybe.Nothing
        }
...
instance Data.Aeson.Types.ToJSON.ToJSON List_external_subscription_external_payment_phasesParametersQueryOrder where
    toJSON (List_external_subscription_external_payment_phasesParametersQueryOrderOther val) = val
    toJSON (List_external_subscription_external_payment_phasesParametersQueryOrderTyped val) = Data.Aeson.Types.ToJSON.toJSON val
    toJSON (List_external_subscription_external_payment_phasesParametersQueryOrderEnumAsc) = "asc"
    toJSON (List_external_subscription_external_payment_phasesParametersQueryOrderEnumDesc) = "desc"
instance Data.Aeson.Types.FromJSON.FromJSON List_external_subscription_external_payment_phasesParametersQueryOrder where
    parseJSON val =
        GHC.Base.pure
            ( if
                | val GHC.Classes.== "asc" -> List_external_subscription_external_payment_phasesParametersQueryOrderEnumAsc
                | val GHC.Classes.== "desc" -> List_external_subscription_external_payment_phasesParametersQueryOrderEnumDesc
                | GHC.Base.otherwise -> List_external_subscription_external_payment_phasesParametersQueryOrderOther val
            )
...
instance Data.Aeson.Types.ToJSON.ToJSON List_external_subscription_external_payment_phasesParametersQuerySort where
    toJSON (List_external_subscription_external_payment_phasesParametersQuerySortOther val) = val
    toJSON (List_external_subscription_external_payment_phasesParametersQuerySortTyped val) = Data.Aeson.Types.ToJSON.toJSON val
    toJSON (List_external_subscription_external_payment_phasesParametersQuerySortEnumCreated_at) = "created_at"
    toJSON (List_external_subscription_external_payment_phasesParametersQuerySortEnumUpdated_at) = "updated_at"
instance Data.Aeson.Types.FromJSON.FromJSON List_external_subscription_external_payment_phasesParametersQuerySort where
    parseJSON val =
        GHC.Base.pure
            ( if
                | val GHC.Classes.== "created_at" -> List_external_subscription_external_payment_phasesParametersQuerySortEnumCreated_at
                | val GHC.Classes.== "updated_at" -> List_external_subscription_external_payment_phasesParametersQuerySortEnumUpdated_at
                | GHC.Base.otherwise -> List_external_subscription_external_payment_phasesParametersQuerySortOther val
            )
...
list_external_subscription_external_payment_phasesRaw parameters =
    GHC.Base.id
        ( RecurlyClient.Common.doCallWithConfigurationM
            (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET")
            "/external_subscriptions/{external_subscription_id}/external_payment_phases"
