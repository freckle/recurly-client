...
module RecurlyClient.Operations.Reopen_invoice where
...
reopen_invoice ::
    ...
    RecurlyClient.Common.ClientT m (Network.HTTP.Client.Types.Response Reopen_invoiceResponse)
reopen_invoice invoice_id =
    GHC.Base.fmap
        ( \response_0 ->
            GHC.Base.fmap
                ( Data.Either.either Reopen_invoiceResponseError GHC.Base.id
                    GHC.Base.. ( \response body ->
                                    if
                                        | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) ->
                                            Reopen_invoiceResponse200
...
data Reopen_invoiceResponse
    = -- | Means either no matching case available or a parse error
      Reopen_invoiceResponseError GHC.Base.String
    | -- | The updated invoice.
...
-}
reopen_invoiceWithConfiguration ::
    forall m.
    (RecurlyClient.Common.MonadHTTP m) =>
    ...
    Data.Text.Internal.Text ->
    -- | Monadic computation which returns the result of the operation
    m (Network.HTTP.Client.Types.Response Reopen_invoiceResponse)
reopen_invoiceWithConfiguration
    config
    invoice_id =
        GHC.Base.fmap
...
The same as 'reopen_invoice' but returns the raw 'Data.ByteString.ByteString'.
-}
reopen_invoiceRaw ::
    forall m.
    (RecurlyClient.Common.MonadHTTP m) =>
...
reopen_invoiceRaw invoice_id = GHC.Base.id (RecurlyClient.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "PUT") ("/invoices/" GHC.Base.<> (RecurlyClient.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (RecurlyClient.Common.textToByte GHC.Base.$ RecurlyClient.Common.stringifyModel invoice_id)) GHC.Base.<> "/reopen")) GHC.Base.mempty)

{- | > PUT /invoices/{invoice_id}/reopen

The same as 'reopen_invoice' but accepts an explicit configuration and returns the raw 'Data.ByteString.ByteString'.
-}
reopen_invoiceWithConfigurationRaw ::
    forall m.
    (RecurlyClient.Common.MonadHTTP m) =>
    -- | The configuration to use in the request
    RecurlyClient.Common.Configuration ->
