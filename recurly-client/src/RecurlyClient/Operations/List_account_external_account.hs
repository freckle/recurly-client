...
module RecurlyClient.Operations.List_account_external_account where
...
list_account_external_account ::
    ...
    RecurlyClient.Common.ClientT m (Network.HTTP.Client.Types.Response List_account_external_accountResponse)
list_account_external_account =
    GHC.Base.fmap
        ( \response_0 ->
            GHC.Base.fmap
                ( Data.Either.either List_account_external_accountResponseError GHC.Base.id
                    GHC.Base.. ( \response body ->
                                    if
                                        | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) ->
                                            List_account_external_accountResponse200
                                        ...
                                        | (\status_2 -> Network.HTTP.Types.Status.statusCode status_2 GHC.Classes.== 404) (Network.HTTP.Client.Types.responseStatus response) ->
                                            List_account_external_accountResponse404
                                                Data.Functor.<$> ( Data.Aeson.eitherDecodeStrict body ::
                                                                    Data.Either.Either
                                                                        GHC.Base.String
                                                                        Error
                                        ...
                                        | (\status_3 -> Network.HTTP.Types.Status.statusCode status_3 GHC.Classes.== 406) (Network.HTTP.Client.Types.responseStatus response) ->
                                            List_account_external_accountResponse406
                                                Data.Functor.<$> ( Data.Aeson.eitherDecodeStrict body ::
                                                                    Data.Either.Either
                                                                        GHC.Base.String
                                                                        Error
                                        ...
                                        | (\status_4 -> Network.HTTP.Types.Status.statusCode status_4 GHC.Classes.== 422) (Network.HTTP.Client.Types.responseStatus response) ->
                                            List_account_external_accountResponse422
                                                Data.Functor.<$> ( Data.Aeson.eitherDecodeStrict body ::
                                                                    Data.Either.Either
                                                                        GHC.Base.String
                                                                        Error
                                        ...
                                        | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) ->
                                            List_account_external_accountResponseDefault
                                                Data.Functor.<$> ( Data.Aeson.eitherDecodeStrict body ::
                                                                    Data.Either.Either
                                                                        GHC.Base.String
                                                                        Error
        ...
        (RecurlyClient.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") "/accounts/{account_id}/external_accounts" GHC.Base.mempty)
...
data List_account_external_accountResponse
    = -- | Means either no matching case available or a parse error
      List_account_external_accountResponseError GHC.Base.String
...
-}
list_account_external_accountWithConfiguration ::
    forall m.
    (RecurlyClient.Common.MonadHTTP m) =>
    -- | The configuration to use in the request
    RecurlyClient.Common.Configuration ->
    -- | Monadic computation which returns the result of the operation
    m (Network.HTTP.Client.Types.Response List_account_external_accountResponse)
list_account_external_accountWithConfiguration config =
    GHC.Base.fmap
        ( \response_5 ->
            GHC.Base.fmap
                ( Data.Either.either List_account_external_accountResponseError GHC.Base.id
        ...
        (RecurlyClient.Common.doCallWithConfiguration config (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") "/accounts/{account_id}/external_accounts" GHC.Base.mempty)

{- | > GET /accounts/{account_id}/external_accounts

The same as 'list_account_external_account' but returns the raw 'Data.ByteString.ByteString'.
-}
list_account_external_accountRaw ::
    forall m.
    (RecurlyClient.Common.MonadHTTP m) =>
    -- | Monadic computation which returns the result of the operation
    RecurlyClient.Common.ClientT m (Network.HTTP.Client.Types.Response Data.ByteString.Internal.Type.ByteString)
list_account_external_accountRaw = GHC.Base.id (RecurlyClient.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") "/accounts/{account_id}/external_accounts" GHC.Base.mempty)

{- | > GET /accounts/{account_id}/external_accounts

The same as 'list_account_external_account' but accepts an explicit configuration and returns the raw 'Data.ByteString.ByteString'.
-}
list_account_external_accountWithConfigurationRaw ::
    forall m.
    (RecurlyClient.Common.MonadHTTP m) =>
    -- | The configuration to use in the request
    RecurlyClient.Common.Configuration ->
...
list_account_external_accountWithConfigurationRaw config = GHC.Base.id (RecurlyClient.Common.doCallWithConfiguration config (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") "/accounts/{account_id}/external_accounts" GHC.Base.mempty)
