...
module RecurlyClient.Operations.Remove_plan where
...
remove_plan ::
    ...
    RecurlyClient.Common.ClientT m (Network.HTTP.Client.Types.Response Remove_planResponse)
remove_plan plan_id =
    GHC.Base.fmap
        ( \response_0 ->
            GHC.Base.fmap
                ( Data.Either.either Remove_planResponseError GHC.Base.id
                    GHC.Base.. ( \response body ->
                                    if
                                        | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) ->
                                            Remove_planResponse200
...
data Remove_planResponse
    = -- | Means either no matching case available or a parse error
      Remove_planResponseError GHC.Base.String
    | -- | Plan deleted
...
remove_planWithConfiguration ::
    ...
    Data.Text.Internal.Text ->
    -- | Monadic computation which returns the result of the operation
    m (Network.HTTP.Client.Types.Response Remove_planResponse)
remove_planWithConfiguration
    config
    plan_id =
        GHC.Base.fmap
...
The same as 'remove_plan' but returns the raw 'Data.ByteString.ByteString'.
-}
remove_planRaw ::
    forall m.
    (RecurlyClient.Common.MonadHTTP m) =>
...
remove_planRaw plan_id = GHC.Base.id (RecurlyClient.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "DELETE") ("/plans/" GHC.Base.<> (RecurlyClient.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (RecurlyClient.Common.textToByte GHC.Base.$ RecurlyClient.Common.stringifyModel plan_id)) GHC.Base.<> "")) GHC.Base.mempty)

{- | > DELETE /plans/{plan_id}

The same as 'remove_plan' but accepts an explicit configuration and returns the raw 'Data.ByteString.ByteString'.
-}
remove_planWithConfigurationRaw ::
    forall m.
    (RecurlyClient.Common.MonadHTTP m) =>
    -- | The configuration to use in the request
    RecurlyClient.Common.Configuration ->
...
remove_planWithConfigurationRaw
    config
    plan_id = GHC.Base.id (RecurlyClient.Common.doCallWithConfiguration config (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "DELETE") ("/plans/" GHC.Base.<> (RecurlyClient.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (RecurlyClient.Common.textToByte GHC.Base.$ RecurlyClient.Common.stringifyModel plan_id)) GHC.Base.<> "")) GHC.Base.mempty)
