...
module RecurlyClient.Operations.Update_billing_info where
...
update_billing_info ::
    ...
    RecurlyClient.Common.ClientT m (Network.HTTP.Client.Types.Response Update_billing_infoResponse)
update_billing_info
    account_id
    body =
        GHC.Base.fmap
            ( \response_0 ->
                GHC.Base.fmap
                    ( Data.Either.either Update_billing_infoResponseError GHC.Base.id
                        GHC.Base.. ( \response body ->
                                        if
                                            | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) ->
                                                Update_billing_infoResponse200
                                            ...
                                            | (\status_2 -> Network.HTTP.Types.Status.statusCode status_2 GHC.Classes.== 400) (Network.HTTP.Client.Types.responseStatus response) ->
                                                Update_billing_infoResponse400
                                                    Data.Functor.<$> ( Data.Aeson.eitherDecodeStrict body ::
                                                                        Data.Either.Either
                                                                            GHC.Base.String
                                                                            Error
                                            ...
                                            | (\status_3 -> Network.HTTP.Types.Status.statusCode status_3 GHC.Classes.== 404) (Network.HTTP.Client.Types.responseStatus response) ->
                                                Update_billing_infoResponse404
                                                    Data.Functor.<$> ( Data.Aeson.eitherDecodeStrict body ::
                                                                        Data.Either.Either
                                                                            GHC.Base.String
                                                                            Error
                                            ...
                                            | (\status_4 -> Network.HTTP.Types.Status.statusCode status_4 GHC.Classes.== 422) (Network.HTTP.Client.Types.responseStatus response) ->
                                                Update_billing_infoResponse422
                                                    Data.Functor.<$> ( Data.Aeson.eitherDecodeStrict body ::
                                                                        Data.Either.Either
                                                                            GHC.Base.String
...
data Update_billing_infoResponse
    = -- | Means either no matching case available or a parse error
      Update_billing_infoResponseError GHC.Base.String
    | -- | Updated billing information.
      Update_billing_infoResponse200 BillingInfo
    | -- | Bad request, perhaps invalid JSON?
      Update_billing_infoResponse400 Error
    | -- | Incorrect site or account ID.
      Update_billing_infoResponse404 Error
    | -- | Invalid billing information, or error running the verification transaction.
      Update_billing_infoResponse422 ErrorMayHaveTransaction
    deriving (GHC.Show.Show, GHC.Classes.Eq)

{- | > PUT /accounts/{account_id}/billing_info

The same as 'update_billing_info' but accepts an explicit configuration.
-}
update_billing_infoWithConfiguration ::
    forall m.
    (RecurlyClient.Common.MonadHTTP m) =>
    ...
    BillingInfoCreate ->
    -- | Monadic computation which returns the result of the operation
    m (Network.HTTP.Client.Types.Response Update_billing_infoResponse)
update_billing_infoWithConfiguration
    config
    account_id
    body =
...
The same as 'update_billing_info' but returns the raw 'Data.ByteString.ByteString'.
-}
update_billing_infoRaw ::
    forall m.
    (RecurlyClient.Common.MonadHTTP m) =>
    -- | account_id: Account ID or code. For ID no prefix is used e.g. \`e28zov4fw0v2\`. For code use prefix \`code-\`, e.g. \`code-bob\`.
    Data.Text.Internal.Text ->
...
The same as 'update_billing_info' but accepts an explicit configuration and returns the raw 'Data.ByteString.ByteString'.
-}
update_billing_infoWithConfigurationRaw ::
    forall m.
    (RecurlyClient.Common.MonadHTTP m) =>
    -- | The configuration to use in the request
    RecurlyClient.Common.Configuration ->
