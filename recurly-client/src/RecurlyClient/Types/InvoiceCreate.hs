...
instance Data.Aeson.Types.FromJSON.FromJSON InvoiceCreate where
    parseJSON = Data.Aeson.Types.FromJSON.withObject "InvoiceCreate" (\obj -> ((((((((GHC.Base.pure InvoiceCreate GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "charge_customer_notes")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "collection_method")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "credit_customer_notes")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "net_terms")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "net_terms_type")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "po_number")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "terms_and_conditions")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "vat_reverse_charge_notes"))
