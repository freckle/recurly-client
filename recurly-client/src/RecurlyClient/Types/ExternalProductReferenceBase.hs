...
instance Data.Aeson.Types.ToJSON.ToJSON ExternalProductReferenceBaseExternal_connection_type where
    toJSON (ExternalProductReferenceBaseExternal_connection_typeOther val) = val
    toJSON (ExternalProductReferenceBaseExternal_connection_typeTyped val) = Data.Aeson.Types.ToJSON.toJSON val
    toJSON (ExternalProductReferenceBaseExternal_connection_typeEnumApple_app_store) = "apple_app_store"
    toJSON (ExternalProductReferenceBaseExternal_connection_typeEnumGoogle_play_store) = "google_play_store"
instance Data.Aeson.Types.FromJSON.FromJSON ExternalProductReferenceBaseExternal_connection_type where
    parseJSON val =
        GHC.Base.pure
            ( if
                | val GHC.Classes.== "apple_app_store" -> ExternalProductReferenceBaseExternal_connection_typeEnumApple_app_store
                | val GHC.Classes.== "google_play_store" -> ExternalProductReferenceBaseExternal_connection_typeEnumGoogle_play_store
                | GHC.Base.otherwise -> ExternalProductReferenceBaseExternal_connection_typeOther val
            )
