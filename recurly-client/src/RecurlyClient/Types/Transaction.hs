...
mkTransaction =
    Transaction
        ...
        , transactionIndicator = GHC.Maybe.Nothing
        ...
        , transactionMerchant_reason_code = GHC.Maybe.Nothing
...
instance Data.Aeson.Types.ToJSON.ToJSON TransactionIndicator where
    toJSON (TransactionIndicatorOther val) = val
    toJSON (TransactionIndicatorTyped val) = Data.Aeson.Types.ToJSON.toJSON val
    toJSON (TransactionIndicatorEnumCustomer) = "customer"
    toJSON (TransactionIndicatorEnumMerchant) = "merchant"
instance Data.Aeson.Types.FromJSON.FromJSON TransactionIndicator where
    parseJSON val =
        GHC.Base.pure
            ( if
                | val GHC.Classes.== "customer" -> TransactionIndicatorEnumCustomer
                | val GHC.Classes.== "merchant" -> TransactionIndicatorEnumMerchant
                | GHC.Base.otherwise -> TransactionIndicatorOther val
            )
...
instance Data.Aeson.Types.ToJSON.ToJSON TransactionMerchant_reason_code where
    toJSON (TransactionMerchant_reason_codeOther val) = val
    toJSON (TransactionMerchant_reason_codeTyped val) = Data.Aeson.Types.ToJSON.toJSON val
    toJSON (TransactionMerchant_reason_codeEnumIncremental) = "incremental"
    toJSON (TransactionMerchant_reason_codeEnumNo_show) = "no_show"
    toJSON (TransactionMerchant_reason_codeEnumResubmission) = "resubmission"
    toJSON (TransactionMerchant_reason_codeEnumService_extension) = "service_extension"
    toJSON (TransactionMerchant_reason_codeEnumSplit_shipment) = "split_shipment"
    toJSON (TransactionMerchant_reason_codeEnumTop_up) = "top_up"
instance Data.Aeson.Types.FromJSON.FromJSON TransactionMerchant_reason_code where
    parseJSON val =
        GHC.Base.pure
            ( if
                | val GHC.Classes.== "incremental" -> TransactionMerchant_reason_codeEnumIncremental
                | val GHC.Classes.== "no_show" -> TransactionMerchant_reason_codeEnumNo_show
                | val GHC.Classes.== "resubmission" -> TransactionMerchant_reason_codeEnumResubmission
                | val GHC.Classes.== "service_extension" -> TransactionMerchant_reason_codeEnumService_extension
                | val GHC.Classes.== "split_shipment" -> TransactionMerchant_reason_codeEnumSplit_shipment
                | val GHC.Classes.== "top_up" -> TransactionMerchant_reason_codeEnumTop_up
                | GHC.Base.otherwise -> TransactionMerchant_reason_codeOther val
            )
