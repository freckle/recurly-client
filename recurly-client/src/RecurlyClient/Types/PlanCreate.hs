...
mkPlanCreate planCreateCode planCreateCurrencies planCreateName =
    PlanCreate
        ...
        , planCreateVertex_transaction_type = GHC.Maybe.Nothing
        }
